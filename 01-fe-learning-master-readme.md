...
- [HTTP](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- [Best Practices for Speeding Up Your Web Site](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)：重要技能
...
* [正则表达式](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)：一个正则表达式入门教程，非常值得一看
...
javascript 就看 javascript高级程序设计 。不过这么厚的书看过就会忘。对javascript核心概念的讲解：对象/原型链/         构造函数/执行上下文/作用域链/闭包/this，[这里](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)有篇不错的文章。
