...
- [PostCSS](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)，有关 PostCSS 不是什么？PostCSS 是什么？PostCSS 可以做什么等等问题，文章里面有答案
...
- [ECharts](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 好用，最关键的是支持的图表展示非常之多，强烈推荐
- [Swiper](http://www.swiper.com.cn) - 强大的 Slider 库 其实这类效果库非常多，但文档能那么专业的就很少鸟
- [babel](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- [toastr](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- [impress.js](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- [PhantomJS](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- [前端开发规范手册](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) -  此手册主要实现的目标：代码一致性和最佳实践
- [《babel-handbook》](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 可以用新的规范(如 ```ES6```)写代码，经过 ```babel``` 编译后生成没有兼容问题的代码
...
- [ReactWebpackCookBook](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 此书会引导读者是进入```React```和```Webpack```的世界。 俩都是非常前沿的技术，同时使用会更有趣。
...
- [koa实战](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - “[明河](https://github.com/minghe)出品”这四字已经说明一切。PS：正在连载中
...
- [大漠：写给前端面试者](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 这篇文章不涉及任何的面试题 大漠与大家聊聊面试者与被面者之间的感受...
...
- [命令行的艺术](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 熟练使用命令行是优秀工程师的基础
- [MongoDB 极简实践入门](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 入门推荐的套路，非常浅显易懂
...
- [Alfred](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- [HyperDock](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- [Git 速查](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 分类清晰的速查表
- [Git 简明指南](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 入门```Github```的简明指南，木有高深内容:)
...
- [UI中国](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 光听名字就知道有多高大上鸟:)
...
- [Redux 中文文档](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 作为个前端，React 还是得尝试下的。英文文档就不给大家推荐了~
- [Express API](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 中文手册:) 4.x和3.x都有
- [CI用户指南](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 一个轻量级的 PHP 框架用户指南 推荐指数低的原因是劳资PHP比较弱，囧
...
- [提問的智慧](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)。“當你拋出一個技術問題時，最終是否能得到有用的回答，往往取決於你所提問和追問的方式。本指南將教你如何正確的提問以獲得你滿意的答案。”——摘自原文
- [租房要点](https://github.com/soulteary/tenant-point) - 适用于北上广深杭，大城市打拼__租房__确实是硬伤
- [QQ 群规](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) - 突然某天，有个 QQ 群让我加群 原本我是拒绝的，但当我看完这篇 QQ 群规后... 劳资真的被感动到了，太牛逼、够专业！ 最后，我默默加群鸟:)
