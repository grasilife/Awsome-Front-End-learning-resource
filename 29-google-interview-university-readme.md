...
这一长列表是从 **Google 的指导笔记** 中萃取出来并进行扩展。因此，有些事情你必须去了解一下。我在列表的底部添加了一些额外项，用于解决面试中可能会出现的问题。这些额外项大部分是来自于 Steve Yegge 的“[得到在 Google 工作的机会](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)”。而在 Google 指导笔记的逐字间，它们有时也会被反映出来。
...
- [ ] 面向学生 —— [Google 的职业生涯：技术开发指导](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
- [ ] Google 检索的原理：
...
- [ ] 文章：
    ...
    - [ ] [得到在 Google 的工作机会](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - 所有他所提及的事情都列在了下面
    - [ ] _（早已过期）_ [如何得到 Google 的一份工作，面试题，应聘过程](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- ### 数组（Arrays）
    ...
    - [ ] 介绍：
        ...
        - [数组的基础知识（视频）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [多维数组（视频）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [动态数组（视频）](https://www.coursera.org/learn/data-structures/lecture/EwbnV/dynamic-arrays)
        - [不规则数组（视频）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [调整数组的大小（视频）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- ### 链表（Linked Lists）
    ...
    - [ ] 的确：你需要关于“指向指针的指针”的相关知识：（因为当你传递一个指针到一个函数时，该函数可能会改变指针所指向的地址）该页只是为了让你了解“指向指针的指针”这一概念。但我并不推荐这种链式遍历的风格。因为，这种风格的代码，其可读性和可维护性太低。
        - [指向指针的指针](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- ### 堆栈（Stack）
    ...
    - [ ] [使用堆栈 —— 后进先出（视频）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    - [ ] 可以不实现，因为使用数组来实现并不重要

- ### 队列（Queue）
    - [ ] [使用队列 —— 先进先出（视频）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    ...
    - [ ] [优先级队列（视频）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    - [ ] 使用含有尾部指针的链表来实现:
...
- ### 哈希表（Hash table）
    ...
    - [ ] 在线课程：
        - [ ] [哈希函数的掌握（视频）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [使用哈希表（视频）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [哈希表的支持（视频）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [哈希表的语言支持（视频）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- ### 按位运算（Bitwise operations）
    ...
    - [ ] 好好理解位操作符的含义：&、|、^、~、>>、<<
        ...
        - [ ] [交互式位元抚弄者（The Bit Twiddler Interactive）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    - [ ] 一补数和补码
    ...
    - [ ] 四舍五入2的幂数：
        - [四舍五入到2的下一幂数](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    - [ ] 交换值：
        - [交换（Swap）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    - [ ] 绝对值：
        - [绝对整型（Absolute Integer）](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- ### 系统设计、可伸缩性、数据处理
    ...
    - [ ] [上下文切换操作会耗费多少时间?](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    ...
    - [ ] [一致性哈希](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    - [ ] [NoSQL 模式](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    ...
    - [ ] 面向对象编程的 SOLID 原则:
        ...
        - [ ] S - [单一职责原则](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) | [每个对象的单一职责](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
            - [更多](https://docs.google.com/open?id=0ByOwmqah_nuGNHEtcU5OekdDMkk)
        - [ ] O - [开闭原则](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)  | [生产环境里的对象应该为扩展做准备而不是为更改](https://en.wikipedia.org/wiki/Open/closed_principle)
        ...
        - [ ] L - [里氏代换原则](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) | [基类和继承类遵循 ‘IS A’ 原则](http://stackoverflow.com/questions/56860/what-is-the-liskov-substitution-principle)
        ...
        - [ ] I - [接口隔离原则](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) | 客户端被迫实现用不到的接口
        ...
        - [ ] D -[依赖反转原则](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) | 减少对象里的依赖。
    ...
    - [ ] 可伸缩性:
        ...
        - [ ] [可伸缩的 Web 架构和分布式系统](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [错误的分布式系统解释](https://pages.cs.wisc.edu/~zuyu/files/fallacies.pdf)
        - [ ] [实用编程技术](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
            - [extra: Google Pregel 图形处理](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        ...
        - [ ] [分片](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        ...
        - [ ] [30 分钟看完 YouTuBe 7 年系统扩展经验](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
            - [video](https://www.youtube.com/watch?v=G-lGCC4KKok)
        - [ ] [PayPal 如何用 8 台虚拟机扛住 10 亿日交易量系统](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        ...
        - [ ] [异步 I/O Tarantool 队列](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [什么时候应该用近视查询处理?](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [Google 从单数据中心到故障转移, 到本地多宿主架构的演变](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [Spanner](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [Egnyte: 构建和扩展 PB 级分布式系统架构的经验教训](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [机器学习驱动的编程: 新世界的新编程方式](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [日服务数百万请求的图像优化技术](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [Patreon 架构](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [Tinder: 推荐引擎是如何决定下一个你将会看到谁的?](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [现代缓存设计](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [Facebook 实时视频流扩展](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [在 Amazon AWS 上把服务扩展到 1100 万量级的新手教程](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [对延时敏感的应用是否应该使用 Docker?](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [AMP（Accelerated Mobile Pages）的存在是对 Google 的威胁么?](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [360 度解读 Netflix 技术栈](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [延迟无处不在 - 如何搞定它？](http://highscalability.com/latency-everywhere-and-it-costs-you-sales-how-crush-it)
        - [ ] [无服务器架构](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        ...
        - [ ] [Cinchcast 架构 - 每天处理 1500 小时的音频](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [Justin.Tv 实时视频播放架构](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [Playfish's 社交游戏架构 - 每月五千万用户增长](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [猫途鹰架构 - 40 万访客, 200 万动态页面访问, 30TB 数据](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [PlentyOfFish 架构](http://highscalability.com/plentyoffish-architecture)
        - [ ] [Salesforce 架构 - 如何扛住 13 亿日交易量](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
        - [ ] [ESPN's 架构扩展](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    ...
    - [ ] 系统设计问题练习：下面有一些指导原则，每一个都有相关文档以及在现实中该如何处理。
        ...
        - 练习:
            ...
            - [设计一个在线多人卡牌游戏](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
            ...
            - [设计一个图片分享系统](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- ### 测试
    ...
    - [ ] [测试驱动的开发已死。测试不朽。](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    ...
    - [ ] 依赖注入:
        ...
        - [ ] [测试之道](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    - [ ] [如何编写测试](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- [10 条小贴士让你写出一份还算不错的简历](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
- 这是搞定面试的第一个关键步骤
...
- ### Unicode
    - [ ] [每一个软件开发者的绝对最低限度，必须要知道的关于 Unicode 和字符集知识](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    - [ ] [关于处理文本需要的编码和字符集, 每个程序员绝对需要知道的知识](http://kunststube.net/encoding/)

- ### 字节顺序
    - [ ] [大、小端字节序](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- ### 信息传输, 序列化,和队列化的系统
    - [ ] [Thrift](https://thrift.apache.org/)
        - [教程](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    ...
    - [ ] [RabbitMQ](https://www.rabbitmq.com/)
        - [入门教程](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
    - [ ] [Celery](http://www.celeryproject.org/)
        - [Celery入门](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
- ### 机器学习（Machine Learning）
    ...
    - [ ] [Tensorflow 教程](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
