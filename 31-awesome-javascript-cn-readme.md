...
* FileAPI：JavaScript 文件工具集合。支持多文件上传、拖放和文件分块上传。对于图像，支持裁剪、调整大小和根据 [EXIF](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) 自动调整方向。[官网](https://github.com/mailru/FileAPI)
