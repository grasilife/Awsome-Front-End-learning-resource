...
> 想了解关于该指南及 前端开发 更多信息的同学，可以阅读短文《[致 Front-End Developers](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)》。 想查看优秀的开源项目，可以访问[《Front-End Develop 项目精选》](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)。希望查看精选文章，可以访问[《Front-End Develop 文章精选》](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)。也欢迎企业招聘人才提供工作岗位(請附上薪資)，可以提交到[工作岗位](https://github.com/mulgore/Front-End-Develop-Guide/issues/3)。
...
[Web Front-End Stack](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)：这张图非常详细。
...
* [通用 CSS 笔记、建议与指导](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)：本文档第一部分将探讨语法、格式以及分析 CSS 结构；第二部分将围绕方法论、思维框架以及编写与规划 CSS 的看法；
...
* [Google JavaScript 代码风格指南](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)：Google风格指南不但指出每条规范，还解释了为什么这样写的原因，同时给出了对与错的实例；
...
* [Google JSON 风格指南](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)：该风格指南是对在Google创建JSON APIs而提供的指导性准则和建议。总体来讲，JSON APIs应遵循JSON.org上的规范。这份风格指南澄清和标准化了特定情况，从而使Google的JSON APIs有一种标准的外观和感觉。这些指南适用于基于RPC和基于REST风格的API的JSON请求和响应；
...
* [深入理解JavaScript系列](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)：汤姆大叔2011年翻译的一系列的文章，很值得一读；
...
[前端代码异常日志与监控](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)

### <a id="fed_openAPI"></a> 开放网络标准

[理解OAuth 2.0](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
* [HTTP协议](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
* [React&React Native生态-探索学习](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
* [移动H5前端性能优化指南](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
* [HomeBrew](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)：OS X上非常优秀的包管理工具；
* [HomeBrew-Cask](http://ksmx.me/homebrew-cask-cli-workflow-to-install-mac-applications/)：简洁优雅的Mac OS X软件安装体验；
* [iTerm 2](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)：OS X上一个增强版的shell终端；
...
* [tmux](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)：终端复用神器，帮助在Mac或者Linux上做开发的程序员在使用终端时更加得心应手；
...
* [Postman](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb) Postman是一款功能强大的网页调试与发送网页HTTP请求的Chrome插件。
...
想查看优秀的开源项目，可以访问[《Front-End Develop 项目精选》](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)。
...
* [移动web资源整理](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)：移动web资源整理；
...
* [深入浅出Nodejs读书笔记](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
* [NodeJS的代码调试和性能调优](http://www.barretlee.com/blog/2015/10/07/debug-nodejs-in-command-line/)
* [在 Node.js 应用中集成 Redis](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
* [the-little-mongodb-book-cn](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
* [youdao出品的HEX](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
...
* [V8引擎中的hidden class](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
* [JavaScript V8 性能小贴士](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)

## <a id="fed_community"></a> 社区

访问：[社区列表](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)

## <a id="fed_article"></a> 码农周刊JavaScript和前端部分优秀文章集合

访问：[码农周刊JavaScript和前端部分优秀文章集合](c-users-fuguo-appdata-local-temp-gitbook2lark-153a3022d07bea00fb)
